...
namespace TajeranBerenj
{
    public partial class frmForoshNimdone : Form
    {
        ...
        int GetReferID()
        {
            ...
            TabdilID = (int)dt.Rows[cunt - 1]["ForoshNimdoneID"];
            return TabdilID;
        }
        ...
        void DisplayForoshDone()
        {
            try
            {
                ...
                dgvView.DataMember = "tblForoshNimdone";
                //**************************************************************
                dgvView.Columns["ForoshNimdoneID"].HeaderText = "کد ";
                dgvView.Columns["ForoshNimdoneID"].Width = 45;
                dgvView.Columns["NoDone"].HeaderText = "نوع نیمدونه ";
                dgvView.Columns["NoDone"].Width = 100;
                dgvView.Columns["AnbarName"].HeaderText = "نام انبار";
                dgvView.Columns["AnbarName"].Width = 90;
                dgvView.Columns["Vazn"].HeaderText = "وزن نیمدونه";
        ...
        int GetInDone(string type)
        {
            ...
            try
            {
                ...
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from tblAnbarNimdone where NoNimdone=N" + type + "And NoVorod=" + no;
                adp.Fill(dt);
                int cunt = dt.Rows.Count;
        ...
        int GetInDone(string type, string anbar)
        {
            ...
            try
            {
                ...
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from tblAnbarNimdone where NoNimdone=N" + type + "And AnbarName=N" + anbar + "And NoVorod=" + no;
                adp.Fill(dt);
                int cunt = dt.Rows.Count;
            ...
            {
                MessageBox.Show("خطایی در نمایش اطلاعات رخ11 داده است");
            }
            return indone;
        }
        ...
        int GetOutDone(string type, string anbar)
        {
            ...
            try
            {
                ...
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from tblAnbarNimdone where NoNimdone=N" + type + "And AnbarName=N" + anbar + "And NoVorod=N" + no;
                adp.Fill(dt);
                int cunt = dt.Rows.Count;
            ...
            {
                MessageBox.Show("خطایی در نمایش اطلاعات22 رخ داده است");
            }
            return outdone;
        }
        ...
        void InsertTotblAnbarNimdone(int id)
        {
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "insert into tblAnbarNimdone (NoNimdone,Vazn,NoVorod ,ReferID,ReferNo,AnbarName)values(@NoNimdone,@Vazn,@NoVorod ,@ReferID,@ReferNo,@AnbarName)";
        ...
        void UpdateTotblAnbarDone()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblAnbarNimdone] Set NoNimdone=N'" + cmbBerenjNo.Text + "', AnbarName=N'" + cmbAnbar.Text + "', Vazn=N'" + vazn + "' where ReferNO=N'" + no + "' And ReferID=" + foroshID;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void UpdateTotblSandogh(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblSandogh] Set bes='" + mablagh + "' where ReferID=" + foroshID + " AND ReferNo=N'فروش نیمدونه'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void UpdateTotblHesab(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblHesab] Set bed=N'" + mablagh + "' where ReferID=" + foroshID + "  AND ReferNo=N'فروش نیمدونه'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void DeletetblanbarNimDone()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblAnbarNimdone] where ReferID=@n and ReferNo=N'فروش'";
        ...
        void DeletetblSandogh()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblSandogh] where ReferID=@n and ReferNo=N'فروش نیمدونه'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        void DeletetblHesab()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblHesab] where ReferID=@n and ReferNo=N'فروش نیمدونه'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT into [tblForoshNimdone](Date,NoDone,AnbarName,Vazn,Fee,Mablagh,Takhfif,Tozihat,MoshtariID)values(@Date,@NoDone,@AnbarName,@Vazn,@Fee,@Mablagh,@Takhfif,@Tozihat,@MoshtariID)";
                    cmd.Parameters.AddWithValue("@Date", txtDate.Text);
                    ...
                    /////////////////////////////////////////////////////////////////////////////////////////////////////
                    referID = GetReferID();
                    InsertTotblAnbarNimdone(referID);
        ...
        private void dgvView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                foroshID = (int)dgvView.Rows[e.RowIndex].Cells["ForoshNimdoneID"].Value;
                cmd.Parameters.Clear();
                DataSet ds = new DataSet();
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from [tblForoshNimdone] where ForoshNimdoneID =" + foroshID;
                con.Open();
                adp.Fill(dt);
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        cmd.Parameters.Clear();
                        cmd.Connection = con;
                        cmd.CommandText = "update [tblForoshNimdone] Set NoDone=N'" + cmbBerenjNo.Text +
                            "', Vazn=N'" + vazn +
                            "',Fee=N'" + fee +
                            "',Mablagh=N'" + mablagh +
                            "',Date=N'" + txtDate.Text +
                            ...
                            "' where ForoshNimdoneID=" + foroshID;
                        con.Open();
                        cmd.ExecuteNonQuery();
                        con.Close();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                try
                {
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "Delete from [tblForoshNimdone] where ForoshNimdoneID=@n";
                    cmd.Parameters.AddWithValue("@n", foroshID);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
