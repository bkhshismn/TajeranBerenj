...
namespace TajeranBerenj
{
    public partial class frmKharidSabosNarm : Form
    {
        ...
        int GetReferID()
        {
            ...
            TabdilID = (int)dt.Rows[cunt - 1]["KharidSabosNarmID"];
            return TabdilID;
        }
        ...
        void DisplayForoshDone()
        {
            try
            {
                ...
                dgvView.DataMember = "tblKharidSabosNarm";
                //**************************************************************
                dgvView.Columns["KharidSabosNarmID"].HeaderText = "کد ";
                dgvView.Columns["KharidSabosNarmID"].Width = 45;
        ...
        void UpdateTotblSandogh(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblSandogh] Set bed='" + mablagh + "' where ReferID=" + foroshID + " AND ReferNo=N'خرید سبوس نرم'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void UpdateTotblHesab(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblHesab] Set bes=N'" + mablagh + "' where ReferID=" + foroshID + "  AND ReferNo=N'خرید سبوس نرم'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void DeletetblanbarNimDone()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblAnbarSabosNarm] where ReferID=@n and ReferNo=N'خرید'";
        ...
        void DeletetblSandogh()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblSandogh] where ReferID=@n and ReferNo=N'خرید سبوس نرم'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        void DeletetblHesab()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblHesab] where ReferID=@n and ReferNo=N'خرید سبوس نرم'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT into [tblKharidSabosNarm](Date,AnbarName,Vazn,Fee,Mablagh,Takhfif,Tozihat,MoshtariID)values(@Date,@AnbarName,@Vazn,@Fee,@Mablagh,@Takhfif,@Tozihat,@MoshtariID)";
                    cmd.Parameters.AddWithValue("@Date", txtDate.Text);
                    cmd.Parameters.AddWithValue("@AnbarName", cmbAnbar.Text);
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        cmd.Parameters.Clear();
                        cmd.Connection = con;
                        cmd.CommandText = "update [tblKharidSabosNarm] Set Vazn=N'" + vazn +
                            "',Fee=N'" + fee +
                            "',Mablagh=N'" + mablagh +
                            "',Date=N'" + txtDate.Text +
                            ...
                            "' where KharidSabosNarmID=" + foroshID;
                        con.Open();
                        cmd.ExecuteNonQuery();
                        con.Close();
        ...
        private void dgvView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                foroshID = (int)dgvView.Rows[e.RowIndex].Cells["KharidSabosNarmID"].Value;
                cmd.Parameters.Clear();
                DataSet ds = new DataSet();
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from [tblKharidSabosNarm] where KharidSabosNarmID =" + foroshID;
                con.Open();
                adp.Fill(dt);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                try
                {
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "Delete from [tblKharidSabosNarm] where KharidSabosNarmID=@n";
                    cmd.Parameters.AddWithValue("@n", foroshID);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
