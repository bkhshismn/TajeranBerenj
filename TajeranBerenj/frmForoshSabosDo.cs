...
namespace TajeranBerenj
{
    public partial class frmForoshSabosDo : Form
    {
        ...
        int GetReferID()
        {
            ...
            TabdilID = (int)dt.Rows[cunt - 1]["ForoshSabosDoID"];
            return TabdilID;
        }
        void DisplayForoshDone()
        {
            try
            {
                ...
                dgvView.DataMember = "tblForoshSabosDo";
                //**************************************************************
                dgvView.Columns["ForoshSabosDoID"].HeaderText = "کد ";
                dgvView.Columns["ForoshSabosDoID"].Width = 45;
        ...
        void DeletetblSandogh()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblSandogh] where ReferID=@n and ReferNo=N'فروش سبوس دو'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        void DeletetblHesab()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblHesab] where ReferID=@n and ReferNo=N'فروش سبوس دو'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        void UpdateTotblSandogh(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblSandogh] Set bes='" + mablagh + "' where ReferID=" + foroshID + " AND ReferNo=N'فروش سبوس دو'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void UpdateTotblHesab(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblHesab] Set bed=N'" + mablagh + "' where ReferID=" + foroshID + "  AND ReferNo=N'فروش سبوس دو'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT into [tblForoshSabosDo](Date,Vazn,Fee,Mablagh,Takhfif,Tozihat,MoshtariID)values(@Date,@Vazn,@Fee,@Mablagh,@Takhfif,@Tozihat,@MoshtariID)";
                    cmd.Parameters.AddWithValue("@Date", txtDate.Text);
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        cmd.Parameters.Clear();
                        cmd.Connection = con;
                        cmd.CommandText = "update [tblForoshSabosDo] Set Vazn=N'" + vazn +
                            "',Fee=N'" + fee +
                            "',Mablagh=N'" + mablagh +
                            "',Date=N'" + txtDate.Text +
                            "',Tozihat=N'" + txtTozihat.Text +
                              "',Takhfif='" + txtTakhfif.Text.Replace(",", "") +
                            "' where ForoshSabosDoID=" + foroshID;
                        con.Open();
                        cmd.ExecuteNonQuery();
                        con.Close();
        ...
        private void dgvView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                foroshID = (int)dgvView.Rows[e.RowIndex].Cells["ForoshSabosDoID"].Value;
                cmd.Parameters.Clear();
                DataSet ds = new DataSet();
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from [tblForoshSabosDo] where ForoshSabosDoID =" + foroshID;
                con.Open();
                adp.Fill(dt);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                try
                {
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "Delete from [tblForoshSabosDo] where ForoshSabosDoID=@n";
                    cmd.Parameters.AddWithValue("@n", foroshID);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
