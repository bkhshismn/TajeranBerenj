...
namespace TajeranBerenj
{
    public partial class frmKharidDone : Form
    {
        ...
        int GetReferID()
        {
            ...
            TabdilID = (int)dt.Rows[cunt - 1]["KharidDoneID"];
            return TabdilID;
        }
        ...
        void DisplayForoshDone()
        {
            try
            {
                ...
                dgvView.DataMember = "tblKharidDone";
                //**************************************************************
                dgvView.Columns["KharidDoneID"].HeaderText = "کد ";
                dgvView.Columns["KharidDoneID"].Width = 45;
        ...
        void DeletetblanbarDone()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblAnbarDone] where ReferID=@n and ReferNo=N'خرید'";
        ...
        void DeletetblSandogh()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblSandogh] where ReferID=@n and ReferNo=N'خرید برنج'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        void DeletetblHesab()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblHesab] where ReferID=@n and ReferNo=N'خرید برنج'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        void UpdateTotblSandogh(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblSandogh] Set bed='" + mablagh + "' where ReferID=" + foroshID + " AND ReferNo=N'خرید برنج'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void UpdateTotblHesab(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblHesab] Set bes=N'" + mablagh + "' where ReferID=" + foroshID + "  AND ReferNo=N'خرید برنج'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //{
                    ...
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT into [tblKharidDone](Date,NoDone,AnbarName,Vazn,Fee,Mablagh,Tedad,Takhfif,Tozihat,MoshtariID)values(@Date,@NoDone,@AnbarName,@Vazn,@Fee,@Mablagh,@Tedad,@Takhfif,@Tozihat,@MoshtariID)";
                    cmd.Parameters.AddWithValue("@Date", txtDate.Text);
                    cmd.Parameters.AddWithValue("@NoDone", cmbBerenjNo.Text);
                    cmd.Parameters.AddWithValue("@AnbarName", cmbAnbar.Text);
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        cmd.Parameters.Clear();
                        cmd.Connection = con;
                        cmd.CommandText = "update [tblKharidDone] Set NoDone=N'" + cmbBerenjNo.Text +
        ...
        private void dgvView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                foroshID = (int)dgvView.Rows[e.RowIndex].Cells["KharidDoneID"].Value;
                cmd.Parameters.Clear();
                DataSet ds = new DataSet();
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from [tblKharidDone] where KharidDoneID =" + foroshID;
                con.Open();
                adp.Fill(dt);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                try
                {
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "Delete from [tblKharidDone] where KharidDoneID=@n";
                    cmd.Parameters.AddWithValue("@n", foroshID);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
