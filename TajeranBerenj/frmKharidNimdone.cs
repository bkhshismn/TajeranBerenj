...
namespace TajeranBerenj
{
    public partial class frmKharidNimdone : Form
    {
        ...
        int GetReferID()
        {
            ...
            TabdilID = (int)dt.Rows[cunt - 1]["KharidNimdoneID"];
            return TabdilID;
        }
        ...
        void DisplayForoshDone()
        {
            try
            {
                ...
                dgvView.DataMember = "tblKharidNimdone";
                //**************************************************************
                dgvView.Columns["KharidNimdoneID"].HeaderText = "کد ";
                dgvView.Columns["KharidNimdoneID"].Width = 45;
        ...
        void UpdateTotblSandogh(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblSandogh] Set bed='" + mablagh + "' where ReferID=" + foroshID + " AND ReferNo=N'خرید نیمدونه'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void UpdateTotblHesab(int mablagh)
        {
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "update [tblHesab] Set bes=N'" + mablagh + "' where ReferID=" + foroshID + "  AND ReferNo=N'خرید نیمدونه'";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        void DeletetblanbarNimDone()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblAnbarNimdone] where ReferID=@n and ReferNo=N'خرید'";
        ...
        void DeletetblSandogh()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblSandogh] where ReferID=@n and ReferNo=N'خرید نیمدونه'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        void DeletetblHesab()
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Delete from [tblHesab] where ReferID=@n and ReferNo=N'خرید نیمدونه'";
                cmd.Parameters.AddWithValue("@n", foroshID);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT into [tblKharidNimdone](Date,NoDone,AnbarName,Vazn,Fee,Mablagh,Takhfif,Tozihat,MoshtariID)values(@Date,@NoDone,@AnbarName,@Vazn,@Fee,@Mablagh,@Takhfif,@Tozihat,@MoshtariID)";
                    cmd.Parameters.AddWithValue("@Date", txtDate.Text);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                try
                {
                    cmd.Parameters.Clear();
                    cmd.Connection = con;
                    cmd.CommandText = "Delete from [tblKharidNimdone] where KharidNimdoneID=@n ";
                    cmd.Parameters.AddWithValue("@n", foroshID);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
        ...
        private void dgvView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                foroshID = (int)dgvView.Rows[e.RowIndex].Cells["KharidNimdoneID"].Value;
                cmd.Parameters.Clear();
                DataSet ds = new DataSet();
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from [tblKharidNimdone] where KharidNimdoneID =" + foroshID;
                con.Open();
                adp.Fill(dt);
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        cmd.Parameters.Clear();
                        cmd.Connection = con;
                        cmd.CommandText = "update [tblKharidNimdone] Set NoDone=N'" + cmbBerenjNo.Text +
                            "', Vazn=N'" + vazn +
                            "',Fee=N'" + fee +
                            "',Mablagh=N'" + mablagh +
                            "',Date=N'" + txtDate.Text +
                            ...
                            "' where KharidNimdoneID=" + foroshID;
                        con.Open();
                        cmd.ExecuteNonQuery();
                        con.Close();
